        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-[#111317] border-[#EBFFF2] border-2 p-8 sm:rounded-lg max-w-md w-full">
                <div className="flex justify-between items-center mb-6">
                    <h2 className="font-fustat-medium text-2xl text-[#EBFFF2]">Delete Portfolio</h2>
                ...
                <p className="text-[#EBFFF2] font-fustat-medium mb-6">
                    Are you sure you want to delete <span className="font-fustat-bold">"{portfolio.title}"</span>? 
                ...
                <div className="flex justify-end space-x-4">
                    ...
                    >
                        {processing ? 'Deleting...' : 'Delete Portfolio'}
                    </button>
                </div>
            </div>
        </div>
