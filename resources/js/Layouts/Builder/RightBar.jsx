                    ...
                    <div className={`flex-1 p-4 ${darkMode ? " text-[#EBFFF2]" : " text-[#111317]"}`}>
                        {selectedId === null ? (
                            ...
                            <>
                                ...
                                {selectedItem?.type !== 'image' && selectedItem?.type !== 'slides' && selectedItem?.type !== 'carousel' && selectedItem?.type !== 'video' && selectedItem?.type !== 'spotifyMusic' && (
                                    <>
                                        <label className="text-sm font-fustat-semibold block mb-1">Fill Colour</label>
                                        <ColourPicker
